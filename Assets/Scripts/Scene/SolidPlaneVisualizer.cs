...
{
    /// <summary>
    /// Visualizes a single DetectedPlane in the Unity scene and adds a MeshCollider to it.
    /// </summary>
    public class SolidPlaneVisualizer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Returns the type of the plane that is being visualized.
        /// </summary>
        public DetectedPlaneType GetPlaneType()
        {
            return m_DetectedPlane.PlaneType;
        }
